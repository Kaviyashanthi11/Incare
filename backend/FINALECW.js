...
if (buttonExists) {
 ...
 // Wait for modal (optional)
  try {
    ...
    await handleModalAndCancel(newPage); // 👉 Don't return — continue processing
  } catch {
...
/**
 * Clicks “No” in the modal, extracts Servicing Provider (using the correct selector),
 * then clicks “Cancel” on the claim form. Returns immediately afterward.
 */
